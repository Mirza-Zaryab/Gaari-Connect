    ...
    return (
        <div className="bg-gray-50 h-full">
            ...
            <div className="mx-auto w-5/6 py-24">
                ...
                <div className="flex flex-1 justify-between items-center mb-20">
                    <ThemeProvider theme={mainTheme}>
                        <Paper
                            ...
                            className="flex items-center rounded-md shadow-none border w-full max-w-512 px-8 py-4 "
                        >
                            <Input
                ...
                <div className="">
                    <Box sx={{}} className=" justify-around grid sm:grid-cols-3 md:grid-cols-4 grid-cols-1 gap-10">
