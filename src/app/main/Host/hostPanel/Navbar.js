...
const StyledIcon = styled(NotificationsNoneOutlinedIcon)`
  :hover {
    stroke: #d22a8f;
    fill: #d22a8f;
  }
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-20 mx-32 border-b bg-white">
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item">
                <Button
                  ...
                  className="h-36 rounded-4 text-xs"
                  style={{
                    color: "#FFFFFF",
