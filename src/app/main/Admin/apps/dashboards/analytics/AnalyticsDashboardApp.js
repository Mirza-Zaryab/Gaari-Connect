...
import DataTable2 from './widgets/Table2';
    ...
    <div className="w-full">
      ...
      > */}
        <div className="flex flex-1 flex-col min-w-0 pt-16">
          ...
          <motion.div style={{marginLeft:'20px'}}>
          <h1 style={{marginLeft:'10px'}}><b>Verify Accounts</b></h1>
          <br></br>
          <DataTable />
          </motion.div>
          <br></br>
          ...
          <motion.div style={{marginLeft:'20px'}}>
          <h1 style={{marginLeft:'10px'}}><b>Verify Vehicles</b></h1>
          <br></br>
          <DataTable2/>
          </motion.div>
