...
const demoDir = 'src/app/main/Admin/documentation/material-ui-components/components';
  ...
  contentsArr = contentsArr.map((content, index) => {
    ...
    if (match) {
      ...
      const importPath = name.replace(
        'pages/components/',
        'app/main/Admin/documentation/material-ui-components/components/'
      );
      return `\n<FuseExample
                    className="my-24"
                    iframe={${iframe}}
...
function writeRouteFile(pages) {
  // const importPath = "import %s from 'app/main/Admin/documentation/material-ui-components/pages/%s';";
  ...
  const routeObject =
    "{ path     : '/documentation/material-ui-components/%s', component: lazy(() => import('app/main/Admin/documentation/material-ui-components/pages/%p'))}";
    ...
    list.forEach((file) => {
      ...
      const result = fileSource
        .replace(
          ...
          'app/main/Admin/documentation/material-ui-components/compose'
        )
        .replace(
          new RegExp('docs/src/modules/components/MarkdownElement', 'g'),
          'app/main/Admin/documentation/material-ui-components/utils/MarkdownElement'
        )
        .replace(
          new RegExp('docs/src/modules/components/HighlightedCode', 'g'),
          'app/main/Admin/documentation/material-ui-components/utils/HighlightedCode'
        )
        .replace(new RegExp('/static/', 'g'), '/material-ui-static/');
