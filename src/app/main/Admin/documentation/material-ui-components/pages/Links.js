    ...
    <>
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/links/Links.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/links/Links.js')}
        />
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/links/UnderlineLink.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/links/UnderlineLink.js')}
        />
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Security
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/links/ButtonLink.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/links/ButtonLink.js')}
        />
      </Typography>
    </>
  );
