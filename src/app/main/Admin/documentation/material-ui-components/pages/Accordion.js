    ...
    <>
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/accordion/BasicAccordion.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/accordion/BasicAccordion.js')}
        />
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/accordion/ControlledAccordions.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/accordion/ControlledAccordions.js')}
        />
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Customization
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/accordion/CustomizedAccordions.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/accordion/CustomizedAccordions.js')}
        />
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Performance
