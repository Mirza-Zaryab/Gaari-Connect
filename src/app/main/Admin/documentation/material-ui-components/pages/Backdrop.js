    ...
    <>
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          iframe={false}
          component={
            require('app/main/Admin/documentation/material-ui-components/components/backdrop/SimpleBackdrop.js')
              .default
          }
          raw={require('!raw-loader!app/main/Admin/documentation/material-ui-components/components/backdrop/SimpleBackdrop.js')}
        />
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Unstyled
