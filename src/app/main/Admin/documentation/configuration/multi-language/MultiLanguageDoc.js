  ...
  return (
    <>
      ...
      <FuseHighlight component="pre" className="language-jsx mb-24">
        {require('!raw-loader!app/main/Admin/apps/mail/i18n/en.js')}
      </FuseHighlight>

      <Typography className="mb-16" component="p">
        And register the language file with <code>i18next.addResourceBundle()</code> at
        <code>src/app/main/Admin/apps/mail/MailAppConfig.js</code>
      </Typography>

      <FuseHighlight component="pre" className="language-jsx mb-24">
        {require('!raw-loader!app/main/Admin/apps/mail/MailAppConfig.js')}
      </FuseHighlight>
