...
function FuseAuthorizationDoc() {
  return (
    <>
      ...
      <Typography className="inline-block mb-8 italic" component="code">
        src/app/main/Admin/auth/admin-role-example/AdminRoleExampleConfig.js
      </Typography>

      <FuseHighlight component="pre" className="language-jsx">
        {require('!raw-loader!app/main/Admin/auth/admin-role-example/AdminRoleExampleConfig.js')}
      </FuseHighlight>
      ...
      <Typography className="mb-16" component="p">
        ...
        <br />
        If you redirect the main/Admin route (/), also make sure to set the redirected route config
        <code>auth:null</code>.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        If you are getting this error, make sure authenticated user has rights to access main/Admin route{' '}
        <b>"/"</b>
        or it's redirected route path.
      </Typography>
      <Typography className="mb-16" component="p">
        After successful login, every authenticated user should be able to access to main/Admin route path{' '}
