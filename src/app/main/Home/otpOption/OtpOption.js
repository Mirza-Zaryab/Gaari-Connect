...
function OtpOption() {
    ...
    console.log(otp.data.customer.data.phone_no);
    ...
    function onSubmit() {
        ...
        if (radioValue === '1') {
            ...
            let phone = {
                userphone: otp.data.customer.data.phone_no
            };
            ...
            <div className="flex flex-row justify-center">
                ...
                >
                    <div className="flex mt-20">
                        <IconButton onClick={() => history.push('/Verify')} size="small" className="sm:mb-10 mb-24">
