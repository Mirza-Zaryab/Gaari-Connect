...
import DocumentationNavigation from '../main/Admin/documentation/DocumentationNavigation';
...
const navigationConfig = [
  ...
  // },
  {
    ...
    translate: 'ManageVehicle',
    type: 'item',
    icon: 'image',
    url: '/apps/vehicleinfo/ManageVehicles',
  },
  {
    id: 'manageusers',
    title: 'Manage User',
    translate: 'ManageUser',
    type: 'item',
    icon: 'image',
    url: '/apps/userinfo/ManageUsers',
  },
  {
    id: 'managestaff',
    title: 'Manage Staff',
    ...
    type: 'item',
    icon: 'image',
    url: '/apps/staffinfo/ManageStaffs',
  },
